                      ...
                      <div className="space-y-3">
                        <div className="flex items-start space-x-3">
                          <input
                            ...
                            className="w-4 h-4 appearance-none bg-gray-800 border border-gray-600 rounded cursor-pointer focus:ring-green-500 focus:ring-2 mt-0.5 checked:bg-gray-800 checked:border-gray-600 relative"
                            style={{
