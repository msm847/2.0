  ...
  nodes: [
    {
      ...
      position: { x: 15, y: 15 }, // 1st in line
      structuralLogic:
    ...
    },
    {
      ...
      position: { x: 41, y: 15 }, // 3rd in line
      structuralLogic:
    ...
    },
    {
      ...
      position: { x: 54, y: 15 }, // 4th in line
      structuralLogic:
    ...
    },
    {
      ...
      position: { x: 67, y: 15 }, // 5th in line
      structuralLogic:
    ...
    },
    {
      ...
      position: { x: 85, y: 25 }, // 6th in line
      structuralLogic:
