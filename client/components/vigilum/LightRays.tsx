...
const LightRays = ({
  ...
  useEffect(() => {
    if (!isVisible || !containerRef.current || !isClient) return;
    ...
    const initializeWebGL = async () => {
      ...
      try {
        // Use eval to prevent Rollup from resolving the import at build time
        const OGL = await eval('import("ogl")');
...
void main() {
  ...
  // Show nothing during SSR, CSS fallback for non-WebGL environments
  if (!isClient) {
    return (
      <div
        ref={containerRef}
