...
const Analytics = () => {
  ...
  useEffect(() => {
    // Immediately show the page structure, then load content quickly
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                ...
                >
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Monitor how users interact with governance systems,
                    identifying patterns that indicate potential risks or
                    inefficiencies.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    anomalies and predict potential governance issues before
                    they manifest.
                  </p>
                </div>
              </div>
